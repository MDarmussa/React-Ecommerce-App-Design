...
function AdminCouponCard({ coupons }) { //coupons is coming from AdminAddCoupon
     ...
     const [timestamp, dateString, show, handleClose, handleShow, handleDelete] = CouponCardHook(coupons)
   return (
     <div className="user-address-card my-3 px-2">
          ...
          <Col xs="6">
               <div className="p-2">Coupon Name: {coupons.name} </div>
          </Col>
          <Col xs="6" className="d-flex d-flex justify-content-end">
               <div className="d-flex p-2">
                    <Link to={`/admin/editcoupon/${coupons._id}`} style={{ textDecoration: "none" }}>
